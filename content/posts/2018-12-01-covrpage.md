...
And to learn how the information provided by `covrpage` should be read, read the HOW TO READ THE REPORT vignette.
...
* the creation of a nice logo by Oz Locke. DESCRIBE LOGO.
