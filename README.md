...
`cd` CD stands for change directory - put here the file path to blog wherever you have it on your PC
...
*This is the bit where you do your actual work and make snazzy new things for the webiste. In this instance it's blogs. Here's a handy piece of code to transforms .Rmd files into .md files that render on the website with no problems.*
